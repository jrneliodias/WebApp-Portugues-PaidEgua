...
const textToType = [`Tu sabias que o açaí é uma frutinha que faz parte da nossa cultura?`, 
`Ele é o principal alimento no cotidiano dos paraenses; é servido, quase sempre, com a farinha de mandioca, que para vocês venezuelanos “es harina de yuca”.`]

export default function AcaiIntroApp() {
    const typedText = useTypedText(textToType)
    
    const currentRoute = '/acai0tema27'; // Set the current route dynamically based on your page

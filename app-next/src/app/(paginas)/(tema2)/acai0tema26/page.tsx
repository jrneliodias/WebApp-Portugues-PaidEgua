...
import acai0 from "@/app/images/acaiTriste.png"
import { useTypedText } from "@/app/Hooks/useTypedText";
import NavBar from "@/app/components/NavBar";

const imageSize = 150;

const textToType = [`Égua de ti, mano(a)? Tenta de novo!!`]

export default function AcaiIntroApp() {
    const typedText = useTypedText(textToType)
    
    const currentRoute = '/acai0tema26'; // Set the current route dynamically based on your page
